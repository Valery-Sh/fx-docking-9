 ...
 * @author Valery
 */
public class TestObservableListStringBinding extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        ObservableListStringBinding<String> olb = new ObservableListStringBinding<>(b01.getStyleClass(),",");
        strProp.bind(olb);
        ...
        b01.setOnAction(e->{
            System.err.println("olb = '" + olb.getValue() + "'" + "; strProp = " + strProp.get());

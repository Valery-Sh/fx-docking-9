 ...
 * Text field skin.
 */
public class TextFieldSkin extends TextInputControlSkin<NewTextField> {
    /**
    ...
    public TextFieldSkin(final NewTextField textField) {
        super(textField);
        ...
        if (SHOW_HANDLES) {
            ...
            selectionHandle1.setOnMouseDragged(new EventHandler<MouseEvent>() {
                @Override public void handle(MouseEvent e) {
                    NewTextField textField = (NewTextField) getSkinnable();
...
//            beep();
    ...
    @Override protected void layoutChildren(final double x, final double y,
        ...
        if (textNode != null) {
            ...
            switch (((NewTextField)getSkinnable()).getAlignment().getVpos()) {
                case TOP:
                textY = ascent;
                break;
...
//            IndexRange selection = textField.getSelection();
    ...
    protected HPos getHAlignment() {
        HPos hPos = ((NewTextField)getSkinnable()).getAlignment().getHpos();
        return hPos;
    }

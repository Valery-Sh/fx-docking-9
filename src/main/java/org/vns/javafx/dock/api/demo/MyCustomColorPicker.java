...
public class MyCustomColorPicker extends VBox {
    ...
    public MyCustomColorPicker() {
        ...
        colorRect.setStyle("-fx-border-width: 4; -fx-border-color: green");
        
        final Pane colorRectOpacityContainer = new StackPane();
        colorRectOpacityContainer.setStyle("-fx-border-width: 4; -fx-border-color: aqua; -fx-padding:5 5 5 5; ");
        ...
        colorBar.setStyle("-fx-border-width: 2; -fx-border-color: blue");
        
        newColorRect = new Pane();
        newColorRect.setStyle("-fx-border-width: 2; -fx-border-color: red");
        ...
        colorRectOpacityContainer.getChildren().setAll(colorRectOverlayOne,colorRectOverlayTwo);
        colorRect.getChildren().setAll(colorRectOpacityContainer, colorRectBlackBorder, colorRectIndicator);
        //colorRect.getChildren().setAll(colorRectOpacityContainer, colorRectIndicator);

 ...
 * @author Valery
 */
public class TestCalcSizes3 extends Application {
...
//        root.getChildren().addAll(pane, pane1);
        ...
        resizeBtn.setOnMouseClicked(e -> {
            NodeResizer nr = new NodeResizer(resizeBtn);

 ...
 * @author Valery
 */
public class TestBytePropertyEditor extends Application {
    ...
    public void start(Stage stage) {
        ...
        ObjectProperty<Byte> ip = new SimpleObjectProperty(0);
        ...
        btn1.setOnAction(e -> {
            System.err.println("BytePropertyEditor: ip = " + ip + "; tf1.text = " + tf1.getText());
            ip.set((byte)20);

 ...
 * @param <T>
 */
public class StateProperty1<T extends Dockable> {
    ...
    public StateProperty1(T dockable) {
...
//15.11        dragTransformer = new DragTransformer(this);
    ...
    public void setFloating(boolean floating) {
        if (!isFloating() && floating) {
            //15.11StateTransformer t = new StateTransformer(this);
            //15.11t.makeFloating();

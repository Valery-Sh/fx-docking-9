...
import static org.vns.javafx.dock.api.designer.bean.editor.EffectChildPropertyEditor.createContextMenu;

/**
 *
 * @author Nastia
 */
public class EffectTreePaneItem<E> extends TreePaneItem<E> implements PropertyEditor<Effect> {
    
    private ButtonBase updateButton;

    public EffectTreePaneItem() {
        this(null);
    }

    public EffectTreePaneItem(String name) {
        super(name);
        init();
    }
    private void init(){

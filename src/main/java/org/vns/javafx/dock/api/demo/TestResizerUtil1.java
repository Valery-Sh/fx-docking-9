 ...
 * @author Valery
 */
public class TestResizerUtil1 extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        TilePane rootPane2 = new TilePane();
        ...
        NodeResizer nr = new NodeResizer(custom1, Options.STAGE, Options.APPLY_TRANSLATE_TRANSFORS);

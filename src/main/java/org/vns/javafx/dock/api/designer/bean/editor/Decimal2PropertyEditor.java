 ...
 * @author Olga
 */
public class Decimal2PropertyEditor extends Double2PropertyEditor {

    private int scale = 1;
    private RoundingMode roundingMode = RoundingMode.HALF_UP;
    
    public Decimal2PropertyEditor() {
        this(null, null);
    }

    public Decimal2PropertyEditor(Double minValue, Double maxValue) {
     ...
     */
    public Decimal2PropertyEditor(Double defaultValue) {
        this(defaultValue, null, null);
    }

    public Decimal2PropertyEditor(Double defaultValue, Double minValue, Double maxValue) {
    ...
    public static class Converter extends DoubleStringConverter {
        ...
        private final Decimal2PropertyEditor textField;

        public Converter(Decimal2PropertyEditor textField, Double defaultValue) {

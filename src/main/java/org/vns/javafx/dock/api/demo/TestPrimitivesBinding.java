 ...
 * @author Valery
 */
public class TestPrimitivesBinding extends Application {
    ...
    public void start(Stage stage) {
        ...
        IntegerPropertyEditor editor = new IntegerPropertyEditor("columnIndex");
        editor.bindConstraint(btn1);
        root.getChildren().add(0,editor);
        btn1.setOnAction(e -> {
            System.err.println(" Grid.getColumnIndex(btn1) = " + GridPane.getColumnIndex(btn1));
            System.err.println(" Grid.getColumnIndex(btn2) = " + GridPane.getColumnIndex(btn2));
        });

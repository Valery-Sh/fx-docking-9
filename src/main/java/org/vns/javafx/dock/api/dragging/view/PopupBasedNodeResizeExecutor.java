 ...
 * @author Valery
 */
public class PopupBasedNodeResizeExecutor {
    ...
    private PopupBasedNodeResizer nodeResizer;

    private Region node;

    public PopupBasedNodeResizer getNodeResizer() {
        return nodeResizer;
    }
    ...
    public PopupBasedNodeResizeExecutor(PopupBasedNodeResizer nodeResizer) {
        this(nodeResizer.getWindow(), nodeResizer.getNode());
        this.nodeResizer = nodeResizer;
    }

    public PopupBasedNodeResizeExecutor(Window window, Region node) {
        this.window = window;
        this.node = node;
...
//static int COUNT = 0;
    ...
    public void resizeManaged(double x, double y) {
        ...
        /*            NodeResizer2.NodeLayout nodeLayout = getNodeResizer().nodeLayout;

 ...
 */
public class Byte2PropertyEditor extends Integer2PropertyEditor {

    public Byte2PropertyEditor() {
     ...
     */
    public Byte2PropertyEditor(Byte defaultValue) {
        this(defaultValue, null, null);
    }

    public Byte2PropertyEditor(Byte minValue, Byte maxValue) {
        this((byte) 0, minValue, maxValue);
    }

    public Byte2PropertyEditor(Byte defaultValue, Byte minValue, Byte maxValue) {

 ...
 * {@link  org.vns.javafx.dock.api.DockTreeItemBuilder } interface, 
 * intended for use with {@link  org.vns.javafx.dock.api.DockTarget } objects.
 *
 * The class constructor requires an object of type {@code DockTarget} and 
 * provides a {@link #getDockTarget() } method to access the {@code dockTarget} object.
 * 

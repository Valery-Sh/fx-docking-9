...
public class TestShape extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Line ln1 = new Line(10, 10, 17, 10);
        
        //p1.getChildren().add(ln1);
        Line ln2 = new Line(13, 7, 13, 13);
        //p1.getChildren().add(ln2);
        Shape sh1 = Line.union(ln1, ln2);
        p1.getChildren().add(sh1);

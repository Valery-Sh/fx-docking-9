 ...
 * {@code properties} collection of the node which is a source of the event
 * with event type {@code MouseEvent.DRAG_DETECTED}..
...
public class DragNodeGesture implements DragGesture {
     ...
     * which is used as a  (@code source gesture}.
     * The constructor with a single parameter is used when both the {@code gestureSource}
     * and {@code gestureSourceObject ) point to the same object. 
     * 
 ...
 /**
     * Creates a new instance of the class for the specified parameters.
     * The {@code gestureSource}
     * and {@code gestureSourceObject ) may point to the same or different object.
     * 
     * @param sourceGesture the object of type Node used as gesture source in a 
     *   drag process.
     ...
     * @param sourceGestureObject a new value of the property gestureSourceObjecy
     */
